...
\begin{longtabu} to \textwidth {@{}llll}
    ...
    \normalsize 5+ års erfaring       & 4+ års erfaring    & 4+ års erfaring     & 2+ års erfaring \\\\
    \multicolumn{4}{@{}p{\textwidth}}{\textbf{Kendte programmeringssporg:} Rust (1 år),
    C\# (5+ år), C (2 år), Bash (2 år), Web (JavaScript, HTML, CSS --- 1 år), }\\[4pt]
    \multicolumn{4}{@{}p{\textwidth}}{\textbf{Kendte værktøjer:} Cargo (1 år), \@.NET (5+ år),
