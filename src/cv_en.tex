...
\begin{longtabu} to \textwidth {@{}llll}
    ...
    \multicolumn{4}{@{}p{\textwidth}}{\textbf{Known Programming Languages:} Rust ($\sim\frac{3}{4}$ year),
    C\# (5+ years), C (2 years), Bash (2 years), Web (JavaScript, HTML, CSS --- 1 year), }\\[4pt]
    \multicolumn{4}{@{}p{\textwidth}}{\textbf{Known Tools:} Cargo ($\sim\frac{3}{4}$ year), \@.NET (5+ years),
