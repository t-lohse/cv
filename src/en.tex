...
\vspace{-1em}
\begin{longtabu} to \textwidth {>{\footnotesize\raggedright\arraybackslash}X[2,1]|X[27,1]}
    Sep 2025 -- Now& \p{Trifork A/S}
    Software Pilot at {Trifork A/S} in Aalborg, working with real-time programming and data processing.
    \subpart[\footnotesize]{C++, Flink, Kafka, Spring Boot, Elasticsearch, teamwork}
    ...
    Teaching Assistant in the Imperative Programming course on the 1st semester of the Bachelor's program. %  Software and Computer Science at AAU.
